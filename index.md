...
* Lab 11
    ...
    Lab 11 part-2 was one of the easier programs to do and the result is pretty satisfying. This lab makes a program that creates a high low game in which the player is trying to guess a value. The value that is being guessed is randomly generated by the program and is a number between 1 and 10. The player is given 4 chances to guess the number by guiding the player based on the number inputed. 
